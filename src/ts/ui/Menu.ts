...
export class Menu {
  constructor(main) {
    ...
    // TEST
    this.menus.test = new MenuItem(
      this.el,
      "ge_menu",
      '<i class="material-icons">timeline</i> Test',
      (event) => {
    ...
    // SHARE
    this.menus.share = new MenuItem(
      this.el,
      "ge_menu",
      '<i class="material-icons">arrow_upward</i> Export',
      (event) => {
        if (main.change || !this.exportModal) {
          this.exportModal = new ExportModal("ge_export", {
            main: main,
            position: "fixed",
          });
        }
    ...
    // AUTOUPDATE
    this.menus.autoupdate = new MenuItem(
      this.el,
      "ge_menu",
      ' <i class="material-icons">autorenew</i> Update: ON',
      (event) => {
        if (main.autoupdate) {
          main.autoupdate = false;
          this.menus.autoupdate.name =
            '<i class="material-icons">autorenew</i> Update: OFF';
