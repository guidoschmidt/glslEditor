...
export class Picker {
  ...
  presentModal(x, y) {
    ...
    window.setTimeout(() => {
      this.onClickOutsideHandler = addEvent(
        document.body,
        "click",
        this.onClickOutside,
        this
      );
      this.onKeyPressHandler = addEvent(
        window,
        "keydown",
        this.onKeyPress,
        this
    ...
    this.onMouseDownHandler = addEvent(
      this.el,
      "mousedown",
      this.onMouseDown,
      this
  ...
  onClickOutside(event) {
    ...
    while (
      ...
      !target.classList.contains(this.CSS_PREFIX + "modal")
    ) {
  ...
  onMouseDown(event) {
    ...
    this.onMouseMoveHandler = addEvent(
      this.el,
      "mousemove",
      this.onMouseMove,
      this
